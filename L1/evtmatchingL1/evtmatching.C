...
int evtmatching(TString infforest, TString infl1, TString outfile)
{
  ...
  // TTree* l1TowerTree = new TChain("l1CaloTowerEmuTree/L1CaloTowerTree");
  TTree* l1ADC = (TTree*)fl1->Get("MBefficiency/adc");
  ...
  TDirectory* dl1ADC = outf->mkdir("MBefficiency","");
